...
namespace MonoGameLibrary.Input
{
    public class GamePadInfo
    {
        ...
        /// <summary>
        /// Gets the state of the input for this gamepad during the previous update cycle.
        /// </summary>
        public GamePadState PreviousState { get; private set; }

        /// <summary>
        /// Gets the state of the input for this gamepad during the current update cycle.
        /// </summary>
        ...
        /// </summary>
        /// <param name="playerIndex">The index of player for this gamepad.</param>
        ...
        /// </summary>
        /// <param name="gameTime">A snapshot of the time value for the current frame.</param>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified gamepad button is currently down.
        /// </summary>
        /// <param name="button">The gameoad button to check.</param>
        ...
        /// <param name="time">The amount of the time the vibratiob should occur.</param>
        ...
        /// <summary>
        /// Stop the vibration of all motors for thi gamepad.
        /// </summary>
