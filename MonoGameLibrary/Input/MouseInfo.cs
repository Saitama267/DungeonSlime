...
namespace MonoGameLibrary.Input
{
    public class MouseInfo
    {
        ...
        /// <summary>
        /// Gets the value that indicates if the mouse cursor moved between the previous and current frames.
        /// </summary>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified button is currently up.
        /// </summary>
        /// <param name="button">The mouse button to check.</param>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified button was just pressed on the current frame.
        /// </summary>
        /// <param name="button">The mouse button to check.</param>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified button was just released on the current frame.
        /// </summary>
        /// <param name="button">The mouse button to check.</param>
        ...
        /// </summary>
        /// <param name="x">The x-coordinate location of the mouse in screen space.</param>
        /// <param name="y">The y-coordinate location of the mouse in screen space.</param>
