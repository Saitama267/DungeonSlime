...
namespace MonoGameLibrary.Input
{
    ...
    {
        /// <summary>
        /// Get the state of keyboard input during the previous update cycle.
        /// </summary>
        ...
        /// <returns>true if the specified kry is currently down; otherwise, false.</returns>
        ...
        /// </summary>
        /// <param name="key">The key to check.</param>
        /// <returns>true if the specified kry is currently up; otherwise, false.</returns>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified key was just pressed on the current frame.
        /// </summary>
        /// <param name="key">The key to check.</param>
        ...
        /// <summary>
        /// Returns a value that indicates whether the specified key was just released on the current frame.
        /// </summary>
        /// <param name="key">The key to check.</param>
