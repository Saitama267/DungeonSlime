...
namespace MonoGameLibrary
{
    public readonly struct Circle : IEquatable<Circle>
    {
        ...
        /// <summary>
        /// Gets the circle with X=0, Y=0, and Radius=0.
        /// </summary>
        ...
        /// <summary>
        /// Gets the y-coordinate of the highest point in the circle.
        /// </summary>
        public readonly int Top => Y - Radius;

        /// <summary>
        /// Gets the y-coordinate of the lowest point in the circle.
        /// </summary>
        public readonly int Bottom => Y + Radius;

        /// <summary>
        /// Gets the X-coordinate of the leftmost point in the circle.
        /// </summary>
        public readonly int Left => X - Radius;

        /// <summary>
        /// Gets the X-coordinate of the rightmost point in the circle.
        /// </summary>
        ...
        /// </summary>
        /// <param name="other">THe cirlce to compare with this circle.</param>
        ...
        /// </summary>
        /// <returns>The hash code for this cirlce as a 32-bit signed integer.</returns>
        ...
        /// <param name="rhs">The circle on the right hand side of the inequality operator</param>
